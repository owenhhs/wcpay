...
class WC_pay {
    ...
    public static function init() {
        ...
        if ( class_exists( 'WC_Payment_Gateway' ) ) {
            ...
            add_filter( 'plugin_action_links_' . plugin_basename( WC_pay_PLUGIN_FILE ), array( __CLASS__, 'plugin_action_links' ) );
    ...
    public static function get_templates_path() {
        return plugin_dir_path( WC_pay_PLUGIN_FILE ) . 'templates/';
    }
    ...
    public static function load_plugin_textdomain() {
        load_plugin_textdomain( 'woocommerce-pay', false, dirname( plugin_basename( WC_pay_PLUGIN_FILE ) ) . '/languages/' );
    }
    ...
    public static function plugin_action_links( $links ) {
        $plugin_links   = array();
        $plugin_links[] = '<a href="' . esc_url( admin_url( 'admin.php?page=wc-settings&tab=checkout&section=pay' ) ) . '">' . __( 'Settings', 'woocommerce-pay' ) . '</a>';
     ...
     *
     * @return array          Payment methods with pay.
     */
    ...
    /**
     * Hides the pay with payment method with the customer lives outside Brazil.
     *
