...
<div class="error">
    ...
    <?php else :
        ...
        ?>
        <p><a href="<?php echo esc_url( $url ); ?>" class="button button-primary"><?php esc_html_e( 'Install Extra Checkout Fields for Brazil', 'woocommerce-pay' ); ?></a></p>
    <?php endif; ?>
</div>
