 ...
 *
 * @package WooCommerce_pay/Classes/XML
 * @version 2.12.0
 */
 ...
 */
class WC_pay_XML extends SimpleXMLElement {
     ...
     * Add payment method.
     *
     * @param string $method Payment method (pay, boleto or eft).
     */
    public function add_method( $method = 'pay' ) {
     ...
     * Add redirect URL.
     *
     * @param string $redirect_url URL to redirect from pay.
     */
     ...
     *
     * @param string $notification_url URL to pay send the payment status notification.
     */
